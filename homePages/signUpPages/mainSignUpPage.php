...
<body>
    ...
    <!-- input user information container -->
    <div class = "container">
        <main>
            ...
            <div class="row g-5">
                <div class="col-md-6 offset-md-3">
                    <form method="POST" action="\PenetrationTestStudy\homePages\signUpPages\signupProcess.php">
                        <div class="col-12">
                        ...
                        <div>
                            <label for="userPwCheck" class="form-label">Password Check</label>
                            <input type="text" class="form-control" id="pwCheck" name="pwCheck">
                        </div>
                        <div class="row pt-3">
                            <div class="col-md-12">
