...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) ."/PenetrationTestStudy/questionService/QuestionPostViewerClass.php");
...
if(!isset($_GET["findMethod"])) $_GET["findMethod"] = "defalut";
if(!isset($_SESSION["login_user"])) $_SESSION["login_user"] = NULL;



if($_SERVER["REQUEST_METHOD"] == "GET") {
    $post = new QuestionPostViewer($_GET["findMethod"]);
...
<body>
    ...
    <form method="GET" action="mainQuestionBoardPage.php">
        <div class="container">
            <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row no-gutters">
                                    <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                                        <select class="form-select" name="findMethod">
                                                ...
                                                <table class="table widget-26">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                                    <a style="text-decoration-line: none;" href='mainQuestionBoardPage.php?sorting=idx'>번호</a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                                    <a style="text-decoration-line: none;" href='mainQuestionBoardPage.php?sorting=title'>제목</a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                                    <a style="text-decoration-line: none;" href='mainQuestionBoardPage.php?sorting=date'>날짜</a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                    ...
                                                    <?php 
                                                        if(!isset($_GET["sorting"])) {
                                                            if($_GET["findMethod"] == "idx") $post->setFindMethod("idx");
                                                            elseif($_GET["findMethod"] == "title") $post->setFindMethod("title");
                                                            elseif($_GET["findMethod"] == "contact") $post->setFindMethod("contact");
                                                            else $post->setFindMethod("defalut");
    
                                                            $post->viewList($db);
                                                        } else {
                                                            $post->setSorting($_GET["sorting"]);
        ...
        <!-- button to makeContent.php -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <button class='btn btn-md btn-primary btn-outlined float-right'><a style='color:white' href='./makeQuestionPage.php'>글쓰기</a></button>
                </div>
            </div>
        <!--  -->
