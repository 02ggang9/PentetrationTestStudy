...
<body>
    ...
    <form method="POST" action="modifyPostProcess.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-18">
                                    <div class="row no-gutters">
                                        <div class="col-18">
                                            <?php echo "<input type='hidden' name='preTitle' value='" . $post->getTitle() . "'>"; ?>
                                            <textarea class="form-control" name="title" rows="1" maxlength="100"><?php echo $post->getTitle(); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <textarea class="form-control" name="content" rows="20"><?php echo $post->getContent(); ?></textarea>
                </div>
            </div>
        </div>
        <br/>
